  ...
  <div class="container">
    <div class="row justify-content-md-center">
      <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
        <h2 class="mb-4 display-5 text-center">Contacto</h2>
        <p class="text-secondary mb-5 text-center">La mejor manera de contactarnos y mas rápida es en este formulario. Porfavor rellene todos los campos y le responderemos lo antes posible.</p>
